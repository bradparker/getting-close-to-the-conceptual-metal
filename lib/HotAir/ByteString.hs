...
import HotAir.State (evalStateT, get, modify, lift)
...
charToByte c =
  case c of
    ...
    '\254' -> 254
    '\255' -> 255
    _ -> error "Non ASCII Char"

instance IsString ByteString where
  fromString = fromList . fmap charToByte . Exts.fromList

instance Show ByteString where
  show = Exts.toList . fmap byteToChar . toList
